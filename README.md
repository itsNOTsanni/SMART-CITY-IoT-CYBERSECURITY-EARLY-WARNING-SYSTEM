...
## 📄 Project Report Outline (40-60 Pages)

1. **Chapter 1: Introduction**
   - 1.1 Context: The Rise of Smart Cities and IoT Vulnerability
   - 1.2 Problem Statement
   - 1.3 Scope and Objectives
2. **Chapter 2: Literature Review**
   - 2.1 Classical Intrusion Detection Systems (IDS)
   - 2.2 Deep Learning in Network Security
   - 2.3 Graph Neural Networks for Cascading Failures
   - 2.4 Explainable AI (XAI) Methods: SHAP vs LIME
3. **Chapter 3: Methodology and Design**
   - 3.1 Overall Framework Architecture
   - 3.2 Machine Learning Anomalies Classifiers
   - 3.3 Graph Construction and Feature Engineering
   - 3.4 Custom GCN Model Implementation
   - 3.5 Sector Impact and Early Warning Formulation
4. **Chapter 4: Implementation Details**
   - 4.1 Development Environment & Software Prerequisites
   - 4.2 Restructured Modular Codebase walk-through
   - 4.3 Training and Evaluation Pipelines
   - 4.4 Multi-Page Command Center Dashboard UI
5. **Chapter 5: Results and Discussion**
   - 5.1 Classifier Metrics (Accuracy, Recall, Confusion Matrices)
   - 5.2 GNN Link Prediction Accuracies & Critical Path Maps
   - 5.3 SHAP Feature Contribution Insights
   - 5.4 Sector Disruption Scenarios (DDoS vs Botnet)
6. **Chapter 6: Conclusion and Future Scope**
   - 6.1 Project Summary
   - 6.2 Key Academic Contributions
   - 6.3 Limitations & Future Direction
7. **References**
